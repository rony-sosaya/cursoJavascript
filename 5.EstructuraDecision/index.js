//ESTRUCTURA DECISIÓN
//El estructura if es utilizada en la mayoria de los lenguajes de programación, como también es la estructura más utilizada en JavaScript
//Esta estructura nos permite tomar decisiones en función de una condición
//if (condición) {
//}
//let unknown = false;
// if (unknown) {
